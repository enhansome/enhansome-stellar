...
* [Stellar Core](https://github.com/stellar/stellar-core) ⭐ 3,297 | 🐛 328 | 🌐 C++ | 📅 2026-08-15 - stellar-core is the backbone of the Stellar network. It maintains a local copy of the ledger, communicating and staying in sync with other instances of stellar-core on the network.
...
* [Stellar Protocol](https://github.com/stellar/stellar-protocol) ⭐ 631 | 🐛 55 | 🌐 RPC | 📅 2026-08-13 - Developer discussion about possible changes to the protocol.
  ...
  * [Core Advancement Proposals](https://github.com/stellar/stellar-protocol/blob/master/core/README.md) ⭐ 631 | 🐛 55 | 🌐 RPC | 📅 2026-08-13
...
* Stellar SDKs
  * [Python SDK](https://github.com/StellarCN/py-stellar-base) ⭐ 368 | 🐛 8 | 🌐 Python | 📅 2026-08-19
  * [Java SDK](https://github.com/stellar/java-stellar-sdk) ⭐ 202 | 🐛 3 | 🌐 Java | 📅 2026-07-16
  * [iOS and macOS SDK](https://github.com/Soneso/stellar-ios-mac-sdk) ⭐ 131 | 🐛 0 | 🌐 Swift | 📅 2026-08-19
  * [C# .NET Core 2.0 SDK](https://github.com/elucidsoft/dotnet-stellar-sdk) ⚠️ Archived
  * [Flutter SDK](https://github.com/Soneso/stellar_flutter_sdk) ⭐ 86 | 🐛 0 | 🌐 Dart | 📅 2026-08-19
